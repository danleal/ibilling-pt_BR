...
$_L['select_a_contact'] = 'Selecione um Contato';
$_L['at_least_one_item_required'] = 'Você deve selecionar ao menos 1 item';
$_L['Subject is Required'] = 'Assunto é Obrigatório';
$_L['Unique Quote URL'] = 'URL unica da Proposta';

# V3.1.0
$_L['API Access Added'] = 'Acesso API Adicionado ';
$_L['select_a_contact'] = 'Por favor, selecione um contato';
$_L['at_least_one_item_required'] = 'Você deve selecionar ao menos 1 item';
$_L['Subject is Required'] = 'Assunto é Obrigatóriod';
$_L['Unique Quote URL'] = 'URL unica da Proposta';

# V3.3.0
$_L['Default Invoice Terms'] = 'Termo Padrão da Proposta';
$_L['Additional Settings'] = 'Configurações Adicionais';
$_L['cron_invoice_created'] = 'CRON Job - Envie automaticamente Proposta por E-mail';

# V3.4.0

$_L['Invoice Creation Method'] = 'Metodo de Criação de Propostas';
$_L['Default'] = 'Padrão';
$_L['V2'] = 'V2';
...
$_L['About'] = 'Sobre';
$_L['Or Install from URL'] = 'Ou instale pela URL';
$_L['Fold Sidebar Default'] = 'Recolher Sidebar por padrão ?';
...
$_L['Live'] = 'Live';
$_L['Sandbox'] = 'Sandbox';
$_L['Drop CSV File Here'] = 'Solte o arquivo CSV aqui';
$_L['Or Click to Upload'] = 'Ou clique em Upload';
$_L['Importing'] = 'Importando';
$_L['Import Contacts'] = 'Importar Contatos';
$_L['Download Sample File'] = 'Download do Arquivo de Exemplo';
$_L['Group'] = 'Grupo';
$_L['Groups'] = 'Grupos';
$_L['Add New Group'] = 'Add Novo Grupo';
$_L['Group Name'] = 'Nome do Grupo';
$_L['Group Deleted Successfully'] = 'Grupo Deletado com Sucesso';
$_L['Welcome Email'] = 'E-mail de Boas-vindas';
$_L['Client:Client Signup Email'] = 'Email de Signup do Cliente';
$_L['Send Client Signup Email'] = 'Escolha SIM para enviar um e-mail de Cadastro ao Cliente.';
$_L['Profile'] = 'Perfil';
$_L['Download'] = 'Download';
$_L['Legacy'] = 'Legacy';
$_L['New'] = 'Novo';
$_L['Default Landing Page'] = 'Landing Page Padrão';
$_L['Admin Login'] = 'Login de Administrador';
$_L['Client Login'] = 'Login de Cliente';
$_L['Recent Quotes'] = 'Propostas Recentes';
$_L['Recent Transactions'] = 'Transações Recentes';

# V 4.2.0

$_L['URL Rewrite'] = 'URL Rewrite';
$_L['Currency Symbol'] = 'Símbolo da Moeda';
$_L['Home Currency'] = 'Moeda Principal';
$_L['Currency Symbol Position'] = 'Posição do Símbolo da Moeda';
$_L['Left'] = 'Esquerda';
$_L['Right'] = 'Direita';
$_L['Currency Decimal Digits'] = 'Digitos Deciamais da Moeda';
$_L['Thousand Separator Placement'] = 'Separador do Milheiro';

# V 4.2.1

$_L['Or Cancel'] = 'Ou Cancele';
$_L['Send Bcc to Admin'] = 'Enviar uma cópia ao Admin? Clique aqui.';
...
$_L['Data View'] = 'Visão dos Dados';
$_L['Refresh'] = 'Recarregar';
$_L['Reset'] = 'Reiniciar';
$_L['Save as Image'] = 'Salvar como Imagem';
$_L['Click to Save'] = 'Clique para Salvar';
$_L['Average'] = 'Média';
$_L['Line'] = 'Linha';
$_L['Bar'] = 'Barra';
$_L['Net Worth'] = 'Valor da Rede';
...
$_L['Application Environment'] = 'Ambiente da Aplicação';
$_L['Server Environment'] = 'Ambiente do Servidor';
$_L['Integration Code'] = 'Código de Integração';
$_L['Client Registration'] = 'Cadastramento do Cliente';
$_L['Register'] = 'Registrar';
$_L['Notes'] = 'Notas';
$_L['Quick Notes'] = 'Nota Rápida';
$_L['Whats on your mind'] = 'O que está pensando?';
$_L['Team'] = 'Time';
$_L['Last Activity'] = 'Últimas Atividades';
$_L['Content Animation'] = 'Animação do Conteúdo';
...
$_L['Editor'] = 'Editor';
$_L['Language Editor'] = 'Idioma do Editor';
$_L['Themes'] = 'Temas';
$_L['Select File to Edit'] = 'Selecione um Arquivo para Editar';
$_L['File'] = 'Arquivo';
$_L['Language File'] = 'Arquivo de Idioma';
$_L['Invoice Layout Print'] = 'Layout da Fatura: Impressão';
$_L['Invoice Layout PDF'] = 'Layout da Fatura: PDF';
$_L['Please Choose a File'] = 'Por favor, selecione um arquivo';
...
$_L['Base Conversion Rate'] = 'Taxa Base de Conversão';
$_L['Currency Example'] = 'ISO da Moeda, exemplo: BRL, USD, GBP, etc...';
$_L['Make Base Currency'] = 'Criar Base de Moeda';
$_L['Base Currency'] = 'Base da Moeda';
$_L['New Company'] = 'Nova Empresa';
$_L['URL'] = 'URL';
$_L['Logo URL'] = 'Logo URL';
$_L['Company Name is required'] = 'Nome da Empresa é Obrigatório.';
$_L['Event Name'] = 'Nome do Evento';
$_L['Priority'] = 'Prioridade';
$_L['Owner'] = 'Proprietário';
$_L['Start Date'] = 'Data de Início';
$_L['End Date'] = 'Data de Término';
$_L['Start Time'] = 'Start Time';
$_L['End Time'] = 'End Time';
$_L['All day event'] = 'Dia Inteiro';
$_L['Related Contacts'] = 'Contatos Relacionados';
$_L['Add Event'] = 'Add Evento';
$_L['Color'] = 'Cor';
$_L['Image'] = 'Imagem';
$_L['Create'] = 'Criar';
$_L['Avatar'] = 'Avatar';
...
$_L['Click to Upload'] = 'Ou clique em Upload';